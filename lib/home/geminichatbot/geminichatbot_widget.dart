...
import 'geminichatbot_model.dart';
export 'geminichatbot_model.dart';
...
class _GeminichatbotWidgetState extends State<GeminichatbotWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'geminichatbot'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('GEMINICHATBOT_PAGE_Icon_kzrc6boz_ON_TAP');
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('GEMINICHATBOT_PAGE_ASK_BTN_ON_TAP');
