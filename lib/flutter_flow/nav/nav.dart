...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'signinscreen',
          path: '/signinscreen',
          builder: (context, params) => const SigninscreenWidget(),
        ),
        FFRoute(
          name: 'home',
          path: '/home',
        ...
        FFRoute(
          name: 'safetytips',
          path: '/safetytips',
          builder: (context, params) => const SafetytipsWidget(),
        ),
        FFRoute(
          name: 'emergency',
          path: '/emergency',
        ...
        FFRoute(
          name: 'privacyypolicy',
          path: '/privacyypolicy',
          builder: (context, params) => const PrivacyypolicyWidget(),
        ),
        FFRoute(
          name: 'feedback',
          path: '/feedback',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'emergencycontacts')
        ...
        FFRoute(
          ...
          path: '/mapnavigation',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'mapnavigation')
              : const MapnavigationWidget(),
        ),
        FFRoute(
          name: 'Awarness',
          path: '/awarness',
          builder: (context, params) => const AwarnessWidget(),
        ),
        FFRoute(
          name: 'emergencycontactlist',
          path: '/emergencycontactlist',
          builder: (context, params) => const EmergencycontactlistWidget(),
        ),
        FFRoute(
          name: 'profile',
          path: '/profile',
        ...
        FFRoute(
          name: 'geminichatbot',
          path: '/geminichatbot',
          builder: (context, params) => const GeminichatbotWidget(),
        ),
        FFRoute(
          name: 'signin1',
          path: '/signin1',
        ...
        FFRoute(
          name: 'signin2',
          path: '/signin2',
          builder: (context, params) => const Signin2Widget(),
        ),
        FFRoute(
          name: 'signin3',
          path: '/signin3',
          builder: (context, params) => const Signin3Widget(),
        ),
        FFRoute(
