...
import 'mapnavigation_model.dart';
export 'mapnavigation_model.dart';
...
class _MapnavigationWidgetState extends State<MapnavigationWidget> {
  late MapnavigationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapnavigationModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'mapnavigation'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: InkWell(
            ...
            onTap: () async {
              logFirebaseEvent('MAPNAVIGATION_PAGE_Icon_22j6mo3m_ON_TAP');
            ...
            children: [
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'MAPNAVIGATION_SEND_YOUR_CURRENT_LOCATION');
                    currentUserLocationValue = await getCurrentUserLocation(
                        defaultLocation: const LatLng(0.0, 0.0));
                    logFirebaseEvent('Button_send_s_m_s');
                    if (isiOS) {
                      await launchUrl(Uri.parse(
                          "sms:${'102'}&body=${Uri.encodeComponent(currentUserLocationValue.toString())}"));
                    } else {
                      await launchUrl(Uri(
                        scheme: 'sms',
                        path: '102',
                  ...
                  text: FFLocalizations.of(context).getText(
                    'olbcbbb4' /* Send Your Current Location */,
                  ),
