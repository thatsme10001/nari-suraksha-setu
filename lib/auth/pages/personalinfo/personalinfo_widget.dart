...
class _PersonalinfoWidgetState extends State<PersonalinfoWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'personalinfo'});
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'PERSONALINFO_UPLOAD_IMAGE_BTN_ON_TAP');
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(11.0, 30.0, 0.0, 0.0),
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PERSONALINFO_SAVE_PROFILE_BTN_ON_TAP');
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                content: const Text('Your Profile is saved !'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
